...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Leandro", "CidTP4", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "CidTP4";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "CidTP4", null, { width: 640, height: 480 });
