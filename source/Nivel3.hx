...
class Nivel3 extends FlxState
{
	...
	override public function create():Void
	{
		...
		var loader:FlxOgmoLoader = new FlxOgmoLoader(AssetPaths.Nivel3__oel);
		nivel3 = loader.loadTilemap(AssetPaths.tiles__png, 32, 32, "Tiles");
		loader.loadEntities(placeEntites, "Entities");
		nivel3.setTileProperties(0, FlxObject.NONE);
		FlxG.camera.follow(player);
		FlxG.camera.setScrollBounds(0, nivel3.width, 0, nivel3.height);
	...
	public function collides():Void
	{
		...
		FlxG.collide(player, nivel3);
		FlxG.collide(palancaRojasGrup, nivel3);
		FlxG.collide(palancaAzulGrup, nivel3);
